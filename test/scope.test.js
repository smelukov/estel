...
describe('Scope', function() {
    ...
    describe('references', function() {
        it('working with references', function() {
            ...
            assert.sameMembers(rootScope.getReferencesNames(), ['a']);
            assert.sameMembers(rootScope.getOwnReferencesNames(), ['a']);
            ...
            assert.sameMembers(childScope1.getReferencesNames(), ['a']);
            assert.lengthOf(childScope1.getOwnReferencesNames(), 0);
            ...
            assert.sameMembers(childScope1.getReferencesNames(), ['a']);
            assert.sameMembers(childScope1.getOwnReferencesNames(), ['a']);
            assert.equal(rootScope.getReference('a'), 'someValue2');
            assert.equal(rootScope.countReferences(), 1);
            assert.equal(rootScope.countOwnReferences(), 1);
            assert.sameMembers(childScope1.getReferencesNames(), ['a']);
            ...
            assert.sameMembers(childScope2.getReferencesNames(), ['a']);
            assert.lengthOf(childScope2.getOwnReferencesNames(), 0);
            ...
            assert.sameMembers(childScope2.getReferencesNames(), ['a', 'b']);
            assert.sameMembers(childScope2.getOwnReferencesNames(), ['b']);
            ...
            assert.equal(childScope2.countOwnReferences(), 0);
            assert.lengthOf(childScope2.getReferencesNames(), 0);
            assert.lengthOf(childScope2.getOwnReferencesNames(), 0);
